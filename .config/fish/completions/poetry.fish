...
complete -c poetry -f -n '__fish_poetry_9cf82bc144790825_complete_no_subcommand' -a cache clear -d 'Clears Poetry\'s cache.'
complete -c poetry -f -n '__fish_poetry_9cf82bc144790825_complete_no_subcommand' -a cache list -d 'List Poetry\'s caches.'
...
complete -c poetry -f -n '__fish_poetry_9cf82bc144790825_complete_no_subcommand' -a debug info -d 'Shows debug information.'
complete -c poetry -f -n '__fish_poetry_9cf82bc144790825_complete_no_subcommand' -a debug resolve -d 'Debugs dependency resolution.'
complete -c poetry -f -n '__fish_poetry_9cf82bc144790825_complete_no_subcommand' -a env info -d 'Displays information about the current environment.'
complete -c poetry -f -n '__fish_poetry_9cf82bc144790825_complete_no_subcommand' -a env list -d 'Lists all virtualenvs associated with the current project.'
complete -c poetry -f -n '__fish_poetry_9cf82bc144790825_complete_no_subcommand' -a env remove -d 'Remove virtual environments associated with the project.'
complete -c poetry -f -n '__fish_poetry_9cf82bc144790825_complete_no_subcommand' -a env use -d 'Activates or creates a new virtualenv for the current project.'
...
complete -c poetry -f -n '__fish_poetry_9cf82bc144790825_complete_no_subcommand' -a self add -d 'Add additional packages to Poetry\'s runtime environment.'
complete -c poetry -f -n '__fish_poetry_9cf82bc144790825_complete_no_subcommand' -a self install -d 'Install locked packages (incl. addons) required by this Poetry installation.'
complete -c poetry -f -n '__fish_poetry_9cf82bc144790825_complete_no_subcommand' -a self lock -d 'Lock the Poetry installation\'s system requirements.'
complete -c poetry -f -n '__fish_poetry_9cf82bc144790825_complete_no_subcommand' -a self remove -d 'Remove additional packages from Poetry\'s runtime environment.'
complete -c poetry -f -n '__fish_poetry_9cf82bc144790825_complete_no_subcommand' -a self show -d 'Show packages from Poetry\'s runtime environment.'
complete -c poetry -f -n '__fish_poetry_9cf82bc144790825_complete_no_subcommand' -a self show plugins -d 'Shows information about the currently installed plugins.'
complete -c poetry -f -n '__fish_poetry_9cf82bc144790825_complete_no_subcommand' -a self update -d 'Updates Poetry to the latest version.'
...
complete -c poetry -f -n '__fish_poetry_9cf82bc144790825_complete_no_subcommand' -a source add -d 'Add source configuration for project.'
complete -c poetry -f -n '__fish_poetry_9cf82bc144790825_complete_no_subcommand' -a source remove -d 'Remove source configured for the project.'
complete -c poetry -f -n '__fish_poetry_9cf82bc144790825_complete_no_subcommand' -a source show -d 'Show information about sources configured for the project.'
